...
export default class HeatPumpWaterHeaterAccessory extends BaseAccessory {
    device;
    configDev;
    service;
    energySaveModeService;
    standardModeService;
    eHeaterService;
    smartModeService;
    disinfectionService;
    ...
    async setTargetTemperature(value) {
        await this.device.set_attribute({
            POWER: true,
            TARGET_TEMPERATURE: limitValue(value, this.configDev.CD_options.minTemp, this.configDev.CD_options.maxTemp),
        });
    }
    getMode(mode) {
    ...
    async setDisinfection(value) {
        await this.device.set_sterilize(value);
    }
}
//# sourceMappingURL=HeatPumpWaterHeaterAccessory.js.map