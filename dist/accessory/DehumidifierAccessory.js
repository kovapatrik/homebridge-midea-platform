...
export default class DehumidifierAccessory extends BaseAccessory {
    ...
    constructor(platform, accessory, device, configDev) {
        ...
        if (this.configDev.A1_options.waterTankSensor !== WaterTankSensor.NONE) {
            ...
            this.handleConfiguredName(this.waterTankService, this.configDev.A1_options.waterTankSensor === WaterTankSensor.CONTACT_SENSOR ? waterTankContactSubtype : waterTankLeakSubtype, 'Water Tank Sensor');
        }
