...
export var Mode;
(function (Mode) {
    Mode[Mode["EnergySave"] = 1] = "EnergySave";
    Mode[Mode["Standard"] = 2] = "Standard";
    Mode[Mode["Compatibilizing"] = 3] = "Compatibilizing";
    Mode[Mode["Smart"] = 4] = "Smart";
    Mode[Mode["Vacation"] = 5] = "Vacation";
})(Mode || (Mode = {}));
class MessageCDBase extends MessageRequest {
...
//# sourceMappingURL=MideaCDMessage.js.map